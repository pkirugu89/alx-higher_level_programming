...
class TestBase_instantiation(unittest.TestCase):
    """
    Unittests for the Base class instantiation.
    """
    ...
    def test_float_id(self):
        self.assertEqual(4.5, Base(5.5).id)

    def test_complex_id(self):
        self.assertEqual(complex(6), Base(complex(6)).id)

    def test_dict_id(self):
        self.assertEqual({"Paul": 2, "Tom": 3}, Base({"Paul": 2, "Tom": 3}).id)
    ...
    def test_two_args(self):
        with self.aseertRaises(TypeError):
            Base(1, 2)


class TestBase_to_json_string(unittest.TestCase):
    """
    Unittests for testing to_json_string mwthod in the Base class.
    """
...
class TestBase_create(unittest.TestCase):
    """
    Unittest for testing create method of the Base Class.
    """
...
class TestBase_load_from_file(unittest.TestCase):
    """
    Unittest for testing load_from_file() in Base class.
    """
